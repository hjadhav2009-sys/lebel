...
from amazon_tool import AmazonLabelWindow
...
class App(tk.Tk):
    ...
    def build_ui(self):
        ...
        ttk.Button(toolbar, text="Amazon Labels", command=self.open_amazon_labels).pack(side="left", padx=12)
    ...
    def open_amazon_labels(self):
        if self.amazon_window is not None and self.amazon_window.winfo_exists():
            self.amazon_window.lift()
            self.amazon_window.focus_force()
            return
        self.amazon_window = AmazonLabelWindow(self)
